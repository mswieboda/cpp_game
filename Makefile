...
SOURCE_FILES = src/main.cpp src/Keys.cpp src/Box.cpp src/Scene.cpp src/GameScene.cpp src/MainMenu.cpp src/Animation.cpp src/Animations.cpp src/Player.cpp
